...
public abstract class Player implements Comparable<Player> {
     ...
     * Be sure to use this constructor, 
     * as it properly populates the players array.
     * The logic in this constructor ensures that players is always full, 
     * although frozen players will still be in it.
     * NOTE: Use getPlayers() each time you need it, 
     * since the reference will change with every new instance.
    ...
    public int compareTo(Player p) {
        return -(susLevel - ((Player)p).susLevel);
    }
    ...
    /**
     * This method overrides the toString method to specify what 
     * will be returned
    ...
    /**
     * This is the setter for susLevel. SusLevel is always a 
     * positive value.
